''' This code (perlin.py) was entirely copied from hnhaefliger (github)
you can find this code for perlin noise at https://github.com/hnhaefliger/pyTerrain
I do not intend to, nor will I use this ecopy for commerical purposes. I originally
found this code (and subsequently a link to his github) at: 
